...
private:
    ...
    void createTextureImage() {
        ...
        stbi_uc* pixels = stbi_load(".textures/texture.jpeg", &textWidth, &textHeight, &textChannels, STBI_rgb_alpha);
        ...
        vkMapMemory(device, stagingBufferMemory, 0, imageSize, 0, &data);
            memcpy(device, pixels, static_cast<size_t>(imageSize));
    ...
    void copyBuffer(VkBuffer srcBuffer, VkBuffer dstBuffer, VkDeviceSize size) {
        ...
        // ONE_TIME_SUBMIT hints to the driver that we'll submit this buffer exactly once
        ...
        // Submit and wait (a fence would allow other work to proceed during the copy)
